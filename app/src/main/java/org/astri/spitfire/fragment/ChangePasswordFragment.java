...
public class ChangePasswordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAccount = view.findViewById(R.id.EmailAddress_et);
        mPwd_old = view.findViewById(R.id.OldPassword_et);
        mPwd_old.setTypeface(Typeface.DEFAULT);
        mPwd_old.setTransformationMethod(new PasswordTransformationMethod());
        mPwd_new = view.findViewById(R.id.NewPassword_et);
        mPwd_new.setTypeface(Typeface.DEFAULT);
        mPwd_new.setTransformationMethod(new PasswordTransformationMethod());
        mPwdCheck = view.findViewById(R.id.ConfirmNewPasssword_et);
        mPwdCheck.setTypeface(Typeface.DEFAULT);
        mPwdCheck.setTransformationMethod(new PasswordTransformationMethod());
        mBackButton = view.findViewById(R.id.Back_bt);
        mChangeButton = view.findViewById(R.id.Change_bt);
        mBackButton.setOnClickListener(resetPwdListener);      //注册界面两个按钮的监听事件
        mChangeButton.setOnClickListener(resetPwdListener);
    ...
    View.OnClickListener resetPwdListener = new View.OnClickListener() {    //不同按钮按下的监听事件选择
