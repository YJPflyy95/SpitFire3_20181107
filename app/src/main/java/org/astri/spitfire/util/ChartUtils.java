...
public class ChartUtils {
    ...
    private static String[] xValuesProcess(int valueType) {
        ...
        if (valueType == dayValue) { // 今日
            ...
            for (int i = 6; i >= 0; i--) {
                dayValues[i] = MyTimeUtils.dateToString(currentTime, MyTimeUtils.dateFormat_day);
            ...
            long currentTime = System.currentTimeMillis();
            for (int i = 6; i >= 0; i--) {
                monthValues[i] = MyTimeUtils.dateToString(currentTime, MyTimeUtils.dateFormat_month);
