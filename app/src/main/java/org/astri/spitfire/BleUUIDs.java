...
//        final static public UUID CHAR_CLIENT_CONFIG       = UUID.fromString("2902");
//        final static public UUID CHAR_CLIENT_CONFIG       = UUID.fromString("0000180d-0000-1000-8000-00805f9b34fb");
    }
